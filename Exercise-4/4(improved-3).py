# -*- coding: utf-8 -*-
"""
Created on Sat Oct  8 18:10:42 2016
...
class nuclei_decay:
    ...
    """
    def __init__(self, number_of_nuclei_A = 50, number_of_nuclei_B = 50, time_constant = 1, time_of_duration = 5, time_step = 0.05 ):
    ...
    def store_results(self):
        myfile = open('computational_physics homework 4(improved-3) data.txt', 'w')

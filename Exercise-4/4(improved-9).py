...
class nuclei_decay:
    ...
    """
    def __init__(self, number_of_nuclei_A = 100, number_of_nuclei_B = 0, time_constantA = 2, time_constantB = 1, time_of_duration = 5, time_step = 0.05 ):
    ...
    def store_results(self):
        myfile = open('4(improved-9) data.txt', 'w')

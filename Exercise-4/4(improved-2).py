...
class nuclei_decay:
    ...
    """
    def __init__(self, number_of_nuclei_A = 75, number_of_nuclei_B = 25, time_constant = 1, time_of_duration = 5, time_step = 0.05 ):
    ...
    def store_results(self):
        myfile = open('computational_physics homework 4(improved-2) data.txt', 'w')

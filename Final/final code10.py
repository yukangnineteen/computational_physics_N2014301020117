# -*- coding: utf-8 -*-
"""
Created on Wed Dec 28 14:53:17 2016
...
#                self.r = 0
                ...
                self.z = 0
                for k in range(i):
#                    rnd1 = random.uniform(-math.sqrt(1/3),math.sqrt(1/3))
#                    rnd2 = random.uniform(-math.sqrt(1/3),math.sqrt(1/3))
#                    rnd3 = random.uniform(-math.sqrt(1/3),math.sqrt(1/3))
                    self.x += random.uniform(-math.sqrt(1/2),math.sqrt(1/2))
                    self.y += random.uniform(-math.sqrt(1/2),math.sqrt(1/2))
#                    self.z += random.uniform(-math.sqrt(1/3),math.sqrt(1/3))
...
pl.text(10,26.5,'$\\leftangle \\rho^2 \\rightangle$ versus time')
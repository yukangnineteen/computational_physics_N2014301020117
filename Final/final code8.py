# -*- coding: utf-8 -*-
"""
Created on Wed Dec 28 20:12:13 2016
...
#            rnd = random.random()
#            if 0<rnd<1/4:
                self.x.append(self.x[i]+random.uniform(-math.sqrt(1/2),math.sqrt(1/2)))
                self.y.append(self.y[i]+random.uniform(-math.sqrt(1/2),math.sqrt(1/2)))
#            elif 1/4<rnd<1/2:

# -*- coding: utf-8 -*-
"""
Created on Wed Dec 28 14:33:20 2016
...
#                    rnd3 = random.uniform(-math.sqrt(1/3),math.sqrt(1/3))
                    self.x += random.uniform(-math.sqrt(1/3),math.sqrt(1/3))
                    self.y += random.uniform(-math.sqrt(1/3),math.sqrt(1/3))
...
pl.text(10,26.5,'$\\leftangle r^2 \\rightangle$ versus time')